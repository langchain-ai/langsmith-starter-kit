...
class Correctness(BaseModel):
    ...
    comment: str = Field(description="Reasoning for the correctness score")
...
class Completeness(BaseModel):
    ...
    comment: str = Field(description="Reasoning for the completeness score")
...
class Professionalism(BaseModel):
    ...
    comment: str = Field(description="Reasoning for the professionalism score")
