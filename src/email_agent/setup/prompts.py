...
def load_action_prompt():
    ...
    return load_prompt("email-agent-action", action_prompt | model_with_tools)
...
def load_triage_prompt():
    ...
    return load_prompt("email-agent-triage", triage_prompt)
...
class Correctness(BaseModel):
    ...
    explanation: str = Field(description="Reasoning for the correctness score")
...
class Completeness(BaseModel):
    ...
    explanation: str = Field(description="Reasoning for the completeness score")
...
class Professionalism(BaseModel):
    ...
    explanation: str = Field(description="Reasoning for the professionalism score")
...
def load_guardrail_prompt_commits():
    ...
    for system in versions:
        ...
        url = load_prompt("guardrail-example", prompt)
    return url
...
def load_all_prompts() -> dict:
    ...
    results = {
        ...
        "correctness_eval": load_next_action_correct_prompt(),
        "completeness_eval": load_final_response_complete_prompt(),
        "professionalism_eval": load_professionalism_prompt(),
